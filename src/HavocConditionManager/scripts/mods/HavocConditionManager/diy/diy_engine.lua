...
function E.new(document,catalog,api,seed)
    ...
    function self.set_script_effects(id,owner,effects)
        ...
        group[id]=effects;minion_revision=-1;bump();return true
    end
    ...
    function self.needs_minion_updates()
        ...
        local function requires(e,global)
            ...
            if global and e.targets.kind~="players" and (e.passive or #e.rules>0 or self.script_globals[e.id]) then return true end
