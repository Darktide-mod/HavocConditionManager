...
Input.commit=function(view)
    ...
    if text==edit.original and not edit.spec.always_apply then Input.cancel(view); return true end
    ...
    Input.cancel(view)
    if value~=edit.spec.value or edit.spec.always_apply then edit.spec.set(value) end
    return true
end
