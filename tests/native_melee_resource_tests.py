...
CONTROLLERS = CHECKS / 'native-melee-controller'
...
SOURCE = PROJECT / 'src/HavocConditionManager/native-melee'
...
legacy_failures = set()
legacy = PROJECT / 'release/4.4.8/HavocConditionManager-4.4.8.zip'
...
timing = L.execute((SOURCE / 'package/lua/timing.lua').read_text(encoding='utf-8'))
resource = L.execute((SOURCE / 'package/lua/resources.lua').read_text(encoding='utf-8'))
