...
local function activate(ctx)
    ...
    ctx:log(string.format("[Frenzied assault %s] move=%.2f melee=+%.2f ranged=+%.2f special=%.2f stagger=native movement_animation=in_place traversal=native attack_animation=in_place engine=1.12.5 unit_ref=low32_shift2 scope=local_authority",REVISION,MOVE,ATTACK-1,RANGED-1,ATTACK))
end
