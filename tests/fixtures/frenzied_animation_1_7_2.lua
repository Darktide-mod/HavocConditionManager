...
local A={available=Native.available,cleanup=Native.cleanup,metrics=Guard.frame_stats}
...
function A.before(current,world,dt)
    ...
    current.animation_population=population
    Native.commit()
    return snapshots
end
